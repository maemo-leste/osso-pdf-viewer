...
*/
osso_return_t
send_dbus_message(const gchar * method, osso_rpc_t * retval, AppData * app_data)
{
 ...
 */
static void pdf_mime_open_cb(ComappSystemData * cas)
{
 ...
 */
static void pdf_hw_event_handler(ComappSystemData * cas)
{
...
static gboolean at_reset_cb(ComappSystemData * cas)
{
	g_debug("at_reset_cb\n");
	just_exit = TRUE;
...
static gboolean at_bgkill_cb(ComappSystemData * cas)
{

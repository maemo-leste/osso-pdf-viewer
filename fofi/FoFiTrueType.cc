...
void FoFiTrueType::convertToCIDType2(char *psName,
  ...
  (*outputFunc)(outputStream, psName, strlen(psName));
  (*outputFunc)(outputStream, (char *)" def\n", 5);
  (*outputFunc)(outputStream, (char *)"/CIDFontType 2 def\n", 19);
  (*outputFunc)(outputStream, (char *)"/FontType 42 def\n", 17);
  ...
  (*outputFunc)(outputStream, (char *)"  /Supplement 0 def\n", 20);
  (*outputFunc)(outputStream, (char *)"  end def\n", 10);
  (*outputFunc)(outputStream, (char *)"/GDBytes 2 def\n", 15);
  if (cidMap) {
    sprintf(buf, "/CIDCount %d def\n", nCIDs);
    (*outputFunc)(outputStream, buf, strlen(buf));
    if (nCIDs > 32767) {
      (*outputFunc)(outputStream, (char *)"/CIDMap [", 9);
      for (i = 0; i < nCIDs; i += 32768 - 16) {
	(*outputFunc)(outputStream, (char *)"<\n", 2);
	for (j = 0; j < 32768 - 16 && i+j < nCIDs; j += 16) {
	  (*outputFunc)(outputStream, (char *)"  ", 2);
	...
	(*outputFunc)(outputStream, (char *)"  >", 3);
      }
      (*outputFunc)(outputStream, (char *)"\n", 1);
      (*outputFunc)(outputStream, (char *)"] def\n", 6);
    } else {
      (*outputFunc)(outputStream, (char *)"/CIDMap <\n", 10);
    ...
    sprintf(buf, (char *)"/CIDCount %d def\n", nGlyphs);
    (*outputFunc)(outputStream, buf, strlen(buf));
    if (nGlyphs > 32767) {
      (*outputFunc)(outputStream, (char *)"/CIDMap [\n", 10);
	...
	sprintf(buf, "    1 index exch dup 2 mul 1 add exch %d add"
		" 255 and put\n", i);
	(*outputFunc)(outputStream, buf, strlen(buf));
	(*outputFunc)(outputStream, (char *)"  } for\n", 8);
      }
      (*outputFunc)(outputStream, (char *)"] def\n", 6);
    } else {
      ...
      (*outputFunc)(outputStream,
		    (char *)"    2 copy dup 2 mul exch -8 bitshift put\n", 42);
      (*outputFunc)(outputStream,
		    (char *)"    1 index exch dup 2 mul 1 add exch 255 and put\n", 50);
      (*outputFunc)(outputStream, (char *)"  } for\n", 8);
      (*outputFunc)(outputStream, (char *)"def\n", 4);
    }
  }
  ...
  (*outputFunc)(outputStream, buf, strlen(buf));
  (*outputFunc)(outputStream, (char *)"/PaintType 0 def\n", 17);
  (*outputFunc)(outputStream, (char *)"/Encoding [] readonly def\n", 26);
  (*outputFunc)(outputStream, (char *)"/CharStrings 1 dict dup begin\n", 30);
  (*outputFunc)(outputStream, (char *)"  /.notdef 0 def\n", 17);
  ...
  // end the dictionary and define the font
  (*outputFunc)(outputStream,
		(char *)"CIDFontName currentdict end /CIDFont defineresource pop\n",
		56);
}
...
void FoFiTrueType::convertToType0(char *psName, Gushort *cidMap, int nCIDs,
  ...
  for (i = 0; i < n; i += 256) {
    ...
    (*outputFunc)(outputStream, buf, strlen(buf));
    (*outputFunc)(outputStream, (char *)"/PaintType 0 def\n", 17);
    (*outputFunc)(outputStream, (char *)"/sfnts ", 7);
    (*outputFunc)(outputStream, psName, strlen(psName));
    (*outputFunc)(outputStream, (char *)"_sfnts def\n", 11);
    ...
    (*outputFunc)(outputStream, (char *)"/CharStrings 257 dict dup begin\n", 32);
    (*outputFunc)(outputStream, (char *)"/.notdef 0 def\n", 15);
    for (j = 0; j < 256 && i+j < n; ++j) {
    ...
    (*outputFunc)(outputStream, (char *)"end readonly def\n", 17);
    (*outputFunc)(outputStream,
		  (char *)"FontName currentdict end definefont pop\n", 40);
  }
  ...
  for (i = 0; i < n; i += 256) {
    ...
    (*outputFunc)(outputStream, psName, strlen(psName));
    sprintf(buf, (char *)"_%02x findfont\n", i >> 8);
    (*outputFunc)(outputStream, buf, strlen(buf));
  }
  (*outputFunc)(outputStream, (char *)"] def\n", 6);
  (*outputFunc)(outputStream, (char *)"FontName currentdict end definefont pop\n", 40);
...
void FoFiTrueType::writeTTF(FoFiOutputFunc outputFunc,
  ...
  for (i = 0; i < nNewTables; ++i) {
	...
	for (j = 0; j < newTables[i].len; ++j) {
	  (*outputFunc)(outputStream, (char *)"\0", 1);
	}
      }
	...
	if (n > 0) {
	  ...
	  if ((k = locaTable[j].len & 3)) {
	    (*outputFunc)(outputStream, (char *)"\0\0\0\0", 4 - k);
	  }
	}
      }
    } else {
    ...
    if (newTables[i].len & 3) {
      (*outputFunc)(outputStream, (char *)"\0\0\0", 4 - (newTables[i].len & 3));
    }
  }
...
void FoFiTrueType::cvtEncoding(char **encoding,
  ...
  if (encoding) {
	...
	name = (char *)".notdef";
      ...
      (*outputFunc)(outputStream, (char *)" put\n", 5);
    }
  } else {
    for (i = 0; i < 256; ++i) {
      sprintf(buf, "dup %d /c%02x put\n", i, i);
...
void FoFiTrueType::cvtCharStrings(char **encoding,
  ...
  (*outputFunc)(outputStream, (char *)"/CharStrings 256 dict dup begin\n", 32);
  (*outputFunc)(outputStream, (char *)"/.notdef 0 def\n", 15);
...
void FoFiTrueType::cvtSfnts(FoFiOutputFunc outputFunc,
  ...
  if (name) {
    ...
    (*outputFunc)(outputStream, (char *)"/sfnts [\n", 9);
  }
...
void FoFiTrueType::dumpString(Guchar *s, int length,
  ...
  if (length & 3) {
    pad = 4 - (length & 3);
    for (i = 0; i < pad; ++i) {
      (*outputFunc)(outputStream, (char *)"00", 2);
    }
  }
  // add an extra zero byte because the Adobe Type 42 spec says so
  (*outputFunc)(outputStream, (char *)"00>\n", 4);
}

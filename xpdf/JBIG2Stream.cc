...
#if 1
  memset(&cxPtr0, 0x00, sizeof(struct JBIG2BitmapPtr));
  memset(&cxPtr1, 0x00, sizeof(struct JBIG2BitmapPtr));
  memset(&atPtr0, 0x00, sizeof(struct JBIG2BitmapPtr));
  memset(&atPtr1, 0x00, sizeof(struct JBIG2BitmapPtr));
  memset(&atPtr2, 0x00, sizeof(struct JBIG2BitmapPtr));
  memset(&atPtr3, 0x00, sizeof(struct JBIG2BitmapPtr));
#endif 
  bitmap = new JBIG2Bitmap(0, w, h);
  bitmap->clearToZero();
...
JBIG2Bitmap *JBIG2Stream::readGenericRefinementRegion(int w, int h,
  ...
  memset(&cxPtr0, 0x00, sizeof(struct JBIG2BitmapPtr));
  memset(&cxPtr1, 0x00, sizeof(struct JBIG2BitmapPtr));
  memset(&cxPtr2, 0x00, sizeof(struct JBIG2BitmapPtr));
  memset(&cxPtr3, 0x00, sizeof(struct JBIG2BitmapPtr));
  memset(&cxPtr4, 0x00, sizeof(struct JBIG2BitmapPtr));
  memset(&cxPtr5, 0x00, sizeof(struct JBIG2BitmapPtr));
  memset(&cxPtr6, 0x00, sizeof(struct JBIG2BitmapPtr));
  memset(&tpgrCXPtr0, 0x00, sizeof(struct JBIG2BitmapPtr));
  memset(&tpgrCXPtr1, 0x00, sizeof(struct JBIG2BitmapPtr));
  memset(&tpgrCXPtr2, 0x00, sizeof(struct JBIG2BitmapPtr));
